...
public class StartAndEndTimeProblem_PersonNumberOfMeetinsCanAttend {
	...
	public static void main(String[] args) {
		...
		System.out.println("How many meeting person can attend : "
				+ getPersonMeetingCount(list));

	}
	static int getPersonMeetingCount(List<Interval> list) {
